...
import { ParserFactory, parseFile, parseFromString, canParseFile, getSupportedFileTypes } from './parser-factory';
...
describe('ParserFactory', () => {
  ...
  describe('createParserForFile', () => {
    ...
    it('should create parser based on content when provided', () => {
      ...
      const parser = ParserFactory.createParserForFile('unknown.file', pdfBuffer);
      expect(parser).toBeInstanceOf(PDFParser);
    });
